...
if(!array_key_exists('firstname', $_POST) || $_POST['firstname'] == '') {// on verifie l'existence du champ et d'un contenu
  $errors ['firstname'] = "vous n'avez pas renseigné votre nom";
  }
if(!array_key_exists('topic', $_POST) || $_POST['topic'] == '') {// on verifie l'existence du champ et d'un contenu
  $errors ['topic'] = "vous n'avez pas renseigné votre sujet";
  }
